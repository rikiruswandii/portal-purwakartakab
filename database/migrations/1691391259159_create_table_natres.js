...
class default_1 extends Schema_1.default {
    ...
    async up() {
        ...
        this.schema.alterTable(this.tableName, (table) => {
            ...
            table.specificType('article', 'CHAR(36)').nullable().index().references('articles.uuid');
...
//# sourceMappingURL=1691391259159_create_table_natres.js.map