...
class Categories extends (0, Helpers_1.compose)(AppBaseModel_1.default, LucidSoftDeletes_1.SoftDeletes) {
}
__decorate([
...
__decorate([
    (0, Orm_1.column)(),
    (0, LucidSlugify_1.slugify)({ strategy: 'dbIncrement', fields: ['type', 'name'], maxLength: 255 }),
    __metadata("design:type", String)
...
__decorate([
    (0, Orm_1.column)(),
    __metadata("design:type", String)
], Categories.prototype, "enhancer", void 0);
__decorate([
